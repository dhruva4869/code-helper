    ...
    <div class="container px-6 py-12 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <h2 class="mt-4 text-base font-medium text-gray-800 dark:text-white">Chat to owner</h2>
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Chat to me Personally</p>
            ...
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Mon-Fri from 9am to 5pm.</p>
