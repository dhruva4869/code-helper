...
function Header() {
  return (
    <div className="rounded-xl navbar-center text-center fixed top-2 w-full z-10 bg-inherit">
        <ul className="menu menu-horizontal menu-lg py-2 my-2 bg-gray-950 rounded-box">
            <li>
